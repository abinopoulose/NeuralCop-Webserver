                ...
                <div class="card col-5 ">
                  <div class="card-header">
                    ...
                    <div class="card-header-action">
                        <a target="_blank"href="https://www.google.com/maps/search/?api=1&query={{$threat->latitude}}%2C{{$threat->longitude}}" class="btn btn-primary">
                  ...
                  <div class="card-body">
                    ...
                    <div class="card-header-action row justify-content-around">
                      <a href="/resolved/{{$threat->id}}" class="btn btn-success" style="width:90%;">
                              Resolved
                      </a>
                    </div>
                    </div>
